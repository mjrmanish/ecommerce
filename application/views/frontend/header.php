            ...
            <div class="offcanvas__content">
               ...
               <div class="offcanvas__contact align-items-center d-none">
                  <div class="offcanvas__contact-icon mr-20">
                     <span>
                        <img src="assets-front/img/icon/contact.png" alt="">
                     </span>
                  </div>
                  ...
                  <div class="offcanvas__select language">
                     <div class="offcanvas__lang d-flex align-items-center justify-content-md-end">
                        <div class="offcanvas__lang-img mr-15">
                           <img src="assets-front/img/icon/language-flag.png" alt="">
                        </div>
         ...
         <div class="cartmini__wrapper d-flex justify-content-between flex-column">
             <div class="cartmini__top-wrapper">
                     ...
                     <div class="cartmini__widget-item">
                         <div class="cartmini__thumb">
                           <a href="product-details.html">
                              <img src="assets-front/img/product/product-1.jpg" alt="">
                           </a>
                         </div>
                 ...
                 <div class="cartmini__empty text-center d-none">
                     <img src="assets-front/img/product/cartmini/empty-cart.png" alt="">
                  ...
                  <div class="row align-items-center">
                     ...
                     <div class="col-xl-4 col-lg-3 col-md-8 col-6">
                        <div class="tp-header-main-right d-flex align-items-center justify-content-end">
                           ...
                           <div class="tp-header-action d-flex align-items-center ml-40">
                        ...
                        <div class="col-xl-3 col-lg-3">
                           <div class="tp-header-category tp-category-menu tp-header-category-toggle">
                              ...
                              <nav class="tp-category-menu-content">
                                 <ul>
                                    <?php foreach($get_cate as $categ):
                                    $check_sub = $this->HomeModel->get_subcate_check($categ->cate_id);
                                    if($check_sub): ?>
                                    <li class="has-dropdown">
                                       <a href="category/<?=$categ->slug?>" class="has-mega-menu">
                                         <?php echo $categ->cate_name ?>
                                       </a>
                                       <ul class="mega-menu tp-submenu">
                                          <li>
                                             <ul>
                                                <?php $subcateg = $this->HomeModel->get_subcateg($categ->cate_id); 
                                                foreach($subcateg as $subcate):
                                                ?>
                                                <li>
                                                   <a href="category/<?=$categ->slug?>/<?=$subcate->slug?>"><?=$subcate->cate_name?></a>
                                                </li>
                                                <?php endforeach;?>
                                             </ul>
                                          </li>
                                    ...
                                    <div class="row row-cols-1 row-cols-lg-4 row-cols-xl-5">
                                          ...
                                          <div class="home-menu-item ">
                                             <a href="index.html">
                                                <div class="home-menu-thumb p-relative fix">
                                                   <img src="assets-front/img/menu/menu-home-1.jpg" alt="">
                                                </div>
                                       ...
                                       <div class="col">
                                          <div class="home-menu-item ">
                                             <a href="index-2.html">
                                                <div class="home-menu-thumb p-relative fix">
                                                   <img src="assets-front/img/menu/menu-home-2.jpg" alt="">
                                                </div>
                                                <div class="home-menu-content">
                                       ...
                                       <div class="col">
                                          <div class="home-menu-item ">
                                             <a href="index-3.html">
                                                <div class="home-menu-thumb p-relative fix">
                                                   <img src="assets-front/img/menu/menu-home-3.jpg" alt="">
                                                </div>
                                                <div class="home-menu-content">
                                       ...
                                       <div class="col">
                                          <div class="home-menu-item ">
                                             <a href="index-4.html">
                                                <div class="home-menu-thumb p-relative fix">
                                                   <img src="assets-front/img/menu/menu-home-4.jpg" alt="">
                                                </div>
                                                <div class="home-menu-content">
                                       ...
                                       <div class="col">
                                          <div class="home-menu-item ">
                                             <a href="index-5.html">
                                                <div class="home-menu-thumb p-relative fix">
                                                   <img src="assets-front/img/menu/menu-home-5.jpg" alt="">
                                                </div>
                                                <div class="home-menu-content">

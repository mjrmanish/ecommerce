                                      ...
                                      <a href="shop.html" class="has-mega-menu">
                                         ...
                                         <ul class="mega-menu tp-submenu">
                                            <li>
                                               ...
                                               <ul>
                                                  <li>
                                                     <a href="shop.html"><img src="assets-front/img/header/menu/menu-1.jpg" alt=""></a>
                                                  </li>
                                                  <li>
                                            ...
                                            <li>
                                               ...
                                               <ul>
                                                  <li>
                                                   <a href="shop.html"><img src="assets-front/img/header/menu/menu-2.jpg" alt=""></a>
                                                  </li>
                                                  <li>
                                            ...
                                            <li>
                                               ...
                                               <ul>
                                                  <li>
                                                   <a href="shop.html"><img src="assets-front/img/header/menu/menu-3.jpg" alt=""></a>
                                                  </li>
                                                  <li>

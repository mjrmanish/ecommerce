                           ...
                           <div class="tab-pane fade show active" id="new-tab-pane" role="tabpanel" aria-labelledby="new-tab" tabindex="0">
                              <div class="row">
                                 <?php if(!empty($product)){ 
                                    ...
                                    $category_name = $this->HomeModel->get_category_name($pro->category);
                                    ?>
                                    ...
                                    <div class="tp-product-item p-relative transition-3 mb-25">
                                       ...
                                       <div class="tp-product-content">
                                          <div class="tp-product-category">
                                             <a href="product/<?=$pro->slug?>"><?=$category_name->cate_name?></a>
                                          </div>
                                          ...
                                          <div class="tp-product-price-wrapper">
                                             <span class="tp-product-price old-price">₹<?=number_format($pro->mrp)?></span>
                                             <span class="tp-product-price new-price">₹<?=number_format($pro->selling_price)?></span>
                                          </div>
                                       </div>
                                    </div>
                                 </div>

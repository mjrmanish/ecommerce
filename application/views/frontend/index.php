                        ...
                        <div class="row align-items-center">
                           ...
                           <div class="col-xl-7 col-lg-6 col-md-6">
                              <div class="tp-slider-thumb text-end">
                                 <img src="./upload/banner/<?php echo $ban->bann_image; ?>" alt="slider-img">
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="tp-product-category-item text-center mb-40">
                        <div class="tp-product-category-thumb fix">
                           <a href="shop-category.html">
                              <img src="./upload/category/<?php echo $categ->cate_image;?>" alt="product-category">
                           </a>
                        </div>
                        <div class="tp-product-category-content">
                           <h3 class="tp-product-category-title">
                              <a href="shop-category.html"><?=$categ->cate_name; ?></a>
                           </h3>
                           <p>20 Product</p>
                        </div>
                     </div>
                                    ...
                                    <div class="tp-product-item p-relative transition-3 mb-25">
                                       <div class="tp-product-thumb p-relative fix m-img">
                                          <a href="product-details.html">
                                             <img src="./upload/product/<?=$pro->pro_main_image?>" alt="<?=$pro->highlights?>">
                                          </a>
                                          <!-- product action -->
                                       ...
                                       <div class="tp-product-content">
                                          <div class="tp-product-category">
                                             <a href="shop.html"><?=$pro->category?></a>
                                          </div>
                                          ...
                                          <div class="tp-product-price-wrapper">
                                             <span class="tp-product-price old-price"><?=$pro->mrp?></span>
                                             <span class="tp-product-price new-price"><?=$pro->selling_price?></span>
                                          </div>
                                       </div>
                                    </div>
                                 </div>

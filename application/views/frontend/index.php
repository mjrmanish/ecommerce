...
<head>
      ...
      <title>MJR-eCommerce  </title>
      <meta name="description" content="">
      <meta name="viewport" content="width=device-width, initial-scale=1">
      <!-- Place favicon.ico in the root directory -->
       <link rel="shortcut icon" type="image/x-icon" href="assets/img/logo/favicon.png">
       <base href="<?=base_url()?>" >
       <?php $this->load->view('frontend/links.php'); ?>
   </head>
   <body>
            ...
            <div id="loading-center-absolute">
               <div class="tp-preloader-content">
                  <div class="tp-preloader-logo">
                     ...
                     <img src="assets-front/img/logo/preloader/preloader-icon.svg" alt="">
                  </div>
      ...
      <main>
               ...
               <div class="swiper-wrapper">
                  ...
                  <div class="tp-slider-item tp-slider-height d-flex align-items-center swiper-slide green-dark-bg">
                     <div class="tp-slider-shape">
                        <img class="tp-slider-shape-1" src="assets-front/img/slider/shape/slider-shape-1.png" alt="slider-shape">
                        <img class="tp-slider-shape-2" src="assets-front/img/slider/shape/slider-shape-2.png" alt="slider-shape">
                        <img class="tp-slider-shape-3" src="assets-front/img/slider/shape/slider-shape-3.png" alt="slider-shape">
                        <img class="tp-slider-shape-4" src="assets-front/img/slider/shape/slider-shape-4.png" alt="slider-shape">
                     </div>
                     <div class="container">
                        <div class="row align-items-center">
                           ...
                           <div class="col-xl-7 col-lg-6 col-md-6">
                              <div class="tp-slider-thumb text-end">
                                 <img src="./upload/<?php echo $ban->bann_image; ?>" alt="slider-img">
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <!-- <div class="tp-slider-item tp-slider-height d-flex align-items-center swiper-slide green-dark-bg" >
                     ...
                     <div class="container">
                        <div class="row align-items-center">
                           ...
                           <div class="col-xl-7 col-lg-6 col-md-6">
                              <div class="tp-slider-thumb text-end">
                                 <img src="assets-front/img/slider/slider-img-2.png" alt="slider-img">
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="tp-slider-item is-light tp-slider-height d-flex align-items-center swiper-slide" data-bg-color="#E3EDF6">
                     ...
                     <div class="container">
                        <div class="row align-items-center">
                           ...
                           <div class="col-xl-7 col-lg-6 col-md-6">
                              <div class="tp-slider-thumb text-end">
                                 <img src="assets-front/img/slider/slider-img-3.png" alt="slider-img">
                              </div>
                           </div>
                        </div>
                     </div>
               ...
               <div class="row row-cols-xl-5 row-cols-lg-5 row-cols-md-4">
                     ...
                     <div class="tp-product-category-item text-center mb-40">
                        <div class="tp-product-category-thumb fix">
                           <a href="shop-category.html">
                              <img src="assets-front/img/product/category/product-cat-1.png" alt="product-category">
                           </a>
                        </div>
                  ...
                  <div class="col">
                     <div class="tp-product-category-item text-center mb-40">
                        <div class="tp-product-category-thumb fix">
                           <a href="shop-category.html">
                              <img src="assets-front/img/product/category/product-cat-2.png" alt="product-category">
                           </a>
                        </div>
                        <div class="tp-product-category-content">
                           <h3 class="tp-product-category-title">
                  ...
                  <div class="col">
                     <div class="tp-product-category-item text-center mb-40">
                        <div class="tp-product-category-thumb fix">
                           <a href="shop-category.html">
                              <img src="assets-front/img/product/category/product-cat-3.png" alt="product-category">
                           </a>
                        </div>
                        <div class="tp-product-category-content">
                           <h3 class="tp-product-category-title">
                  ...
                  <div class="col">
                     <div class="tp-product-category-item text-center mb-40">
                        <div class="tp-product-category-thumb fix">
                           <a href="shop-category.html">
                              <img src="assets-front/img/product/category/product-cat-4.png" alt="product-category">
                           </a>
                        </div>
                        <div class="tp-product-category-content">
                           <h3 class="tp-product-category-title">
                  ...
                  <div class="col">
                     <div class="tp-product-category-item text-center mb-40">
                        <div class="tp-product-category-thumb fix">
                           <a href="shop-category.html">
                              <img src="assets-front/img/product/category/product-cat-5.png" alt="product-category">
                           </a>
                        </div>
                        <div class="tp-product-category-content">
                           <h3 class="tp-product-category-title">
                              ...
                              <div class="row">
                                    ...
                                    <div class="tp-product-item p-relative transition-3 mb-25">
                                       <div class="tp-product-thumb p-relative fix m-img">
                                          <a href="product-details.html">
                                             <img src="assets-front/img/product/product-1.jpg" alt="product-electronic">
                                          </a>
                                 ...
                                 <div class="col-xl-3 col-lg-3 col-sm-6">
                                    <div class="tp-product-item transition-3 mb-25">
                                       <div class="tp-product-thumb p-relative fix m-img">
                                          <a href="product-details.html">
                                             <img src="assets-front/img/product/product-2.jpg" alt="product-electronic">
                                          </a>
                                 ...
                                 <div class="col-xl-3 col-lg-3 col-sm-6">
                                    <div class="tp-product-item transition-3 mb-25">
                                       <div class="tp-product-thumb p-relative fix m-img">
                                          <a href="product-details.html">
                                             <img src="assets-front/img/product/product-3.jpg" alt="product-electronic">
                                          </a>
                                 ...
                                 <div class="col-xl-3 col-lg-3 col-sm-6">
                                    <div class="tp-product-item transition-3 mb-25">
                                       <div class="tp-product-thumb p-relative fix m-img">
                                          <a href="product-details.html">
                                             <img src="assets-front/img/product/product-4.jpg" alt="product-electronic">
                                          </a>
                                 ...
                                 <div class="col-xl-3 col-lg-3 col-sm-6">
                                    <div class="tp-product-item transition-3 mb-25">
                                       <div class="tp-product-thumb p-relative fix m-img">
                                          <a href="product-details.html">
                                             <img src="assets-front/img/product/product-5.jpg" alt="product-electronic">
                                          </a>
                                 ...
                                 <div class="col-xl-3 col-lg-3 col-sm-6">
                                    <div class="tp-product-item transition-3 mb-25">
                                       <div class="tp-product-thumb p-relative fix m-img">
                                          <a href="product-details.html">
                                             <img src="assets-front/img/product/product-5-1.jpg" alt="product-electronic">
                                          </a>
                                 ...
                                 <div class="col-xl-3 col-lg-3 col-sm-6">
                                    <div class="tp-product-item transition-3 mb-25">
                                       <div class="tp-product-thumb p-relative fix m-img">
                                          <a href="product-details.html">
                                             <img src="assets-front/img/product/product-5-2.jpg" alt="product-electronic">
                                          </a>
                                 ...
                                 <div class="col-xl-3 col-lg-3 col-sm-6">
                                    <div class="tp-product-item transition-3 mb-25">
                                       <div class="tp-product-thumb p-relative fix m-img">
                                          <a href="product-details.html">
                                             <img src="assets-front/img/product/product-5-3.jpg" alt="product-electronic">
                                          </a>
               ...
               <div class="row">
                  <div class="col-xl-8 col-lg-7">
                     <div class="tp-banner-item tp-banner-height p-relative mb-30 z-index-1 fix">
                        <div class="tp-banner-thumb include-bg transition-3" data-background="assets-front/img/product/banner/product-banner-1.jpg"></div>
                  ...
                  <div class="col-xl-4 col-lg-5">
                     <div class="tp-banner-item tp-banner-item-sm tp-banner-height p-relative mb-30 z-index-1 fix">
                        <div class="tp-banner-thumb include-bg transition-3" data-background="assets-front/img/product/banner/product-banner-2.jpg"></div>
                        <div class="tp-banner-content">
                           <h3 class="tp-banner-title">
                        ...
                        <div class="tp-product-offer-slider-active swiper-container">
                           <div class="swiper-wrapper">
                              <div class="tp-product-offer-item tp-product-item transition-3 swiper-slide">
                                 <div class="tp-product-thumb p-relative fix m-img">
                                    <a href="product-details.html">
                                       <img src="assets-front/img/product/offer/product-offer-1.jpg" alt="product-electronic">
                                    </a>
                              ...
                              <div class="tp-product-offer-item tp-product-item transition-3 swiper-slide">
                                 <div class="tp-product-thumb p-relative fix m-img">
                                    <a href="product-details.html">
                                       <img src="assets-front/img/product/offer/product-offer-2.jpg" alt="product-electronic">
                                    </a>
                              ...
                              <div class="tp-product-offer-item tp-product-item transition-3 swiper-slide">
                                 <div class="tp-product-thumb p-relative fix m-img">
                                    <a href="product-details.html">
                                       <img src="assets-front/img/product/offer/product-offer-3.jpg" alt="product-electronic">
                                    </a>
                     ...
                     <div class="tp-product-gadget-sidebar mb-40">
                        <div class="tp-product-gadget-categories p-relative fix mb-10">
                           <div class="tp-product-gadget-thumb">
                              <img src="assets-front/img/product/gadget/gadget-girl.png" alt="">
                           </div>
                        ...
                        <div class="tp-product-gadget-banner">
                           <div class="tp-product-gadget-banner-slider-active swiper-container">
                              <div class="swiper-wrapper">
                                 <div class="tp-product-gadget-banner-item swiper-slide include-bg" data-background="assets-front/img/product/gadget/gadget-banner-1.jpg">
                                 ...
                                 <div class="tp-product-gadget-banner-item swiper-slide include-bg" data-background="assets-front/img/product/gadget/gadget-banner-2.jpg">
                                    <div class="tp-product-gadget-banner-content">
                        ...
                        <div class="row">
                           <div class="col-xl-4 col-sm-6">
                              <div class="tp-product-item p-relative transition-3 mb-25">
                                 <div class="tp-product-thumb p-relative fix m-img">
                                    <a href="product-details.html">
                                       <img src="assets-front/img/product/product-12.jpg" alt="product-electronic">
                                    </a>
                           ...
                           <div class="col-xl-4 col-sm-6">
                              <div class="tp-product-item p-relative transition-3 mb-25">
                                 <div class="tp-product-thumb p-relative fix m-img">
                                    <a href="product-details.html">
                                       <img src="assets-front/img/product/product-13.jpg" alt="product-electronic">
                                    </a>
                           ...
                           <div class="col-xl-4 col-sm-6">
                              <div class="tp-product-item p-relative transition-3 mb-25">
                                 <div class="tp-product-thumb p-relative fix m-img">
                                    <a href="product-details.html">
                                       <img src="assets-front/img/product/product-14.jpg" alt="product-electronic">
                                    </a>
                           ...
                           <div class="col-xl-4 col-sm-6">
                              <div class="tp-product-item p-relative transition-3 mb-25">
                                 <div class="tp-product-thumb p-relative fix m-img">
                                    <a href="product-details.html">
                                       <img src="assets-front/img/product/product-15.jpg" alt="product-electronic">
                                    </a>
                           ...
                           <div class="col-xl-4 col-sm-6">
                              <div class="tp-product-item p-relative transition-3 mb-25">
                                 <div class="tp-product-thumb p-relative fix m-img">
                                    <a href="product-details.html">
                                       <img src="assets-front/img/product/product-16.jpg" alt="product-electronic">
                                    </a>
                           ...
                           <div class="col-xl-4 col-sm-6">
                              <div class="tp-product-item p-relative transition-3 mb-25">
                                 <div class="tp-product-thumb p-relative fix m-img">
                                    <a href="product-details.html">
                                       <img src="assets-front/img/product/product-17.jpg" alt="product-electronic">
                                    </a>
                              ...
                              <div class="col-xl-6 col-lg-6">
                                 <div class="tp-product-banner-thumb-wrapper p-relative">
                                    <div class="tp-product-banner-thumb-shape">
                                       ...
                                       <img class="tp-offer-shape" src="assets-front/img/banner/banner-slider-offer.png" alt="">
                                    </div>
         
                                    <div class="tp-product-banner-thumb text-end p-relative z-index-1">
                                       <img src="assets-front/img/banner/banner-slider-1.png" alt="">
                                    </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="row align-items-center">
                              ...
                              <div class="col-xl-6 col-lg-6">
                                 <div class="tp-product-banner-thumb-wrapper p-relative">
                                    ...
                                    <div class="tp-product-banner-thumb text-end p-relative z-index-1">
                                       <img src="assets-front/img/banner/banner-slider-2.png" alt="">
                                    </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="row align-items-center">
                              ...
                              <div class="col-xl-6 col-lg-6">
                                 <div class="tp-product-banner-thumb-wrapper p-relative">
                                    ...
                                    <div class="tp-product-banner-thumb text-end p-relative z-index-1">
                                       <img src="assets-front/img/banner/banner-slider-3.png" alt="">
                                    </div>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="tp-product-arrival-active swiper-container">
                           <div class="swiper-wrapper">
                              <div class="tp-product-item transition-3 mb-25 swiper-slide">
                                 <div class="tp-product-thumb p-relative fix m-img">
                                    <a href="product-details.html">
                                       <img src="assets-front/img/product/product-6.jpg" alt="product-electronic">
                                    </a>
                              ...
                              <div class="tp-product-item transition-3 mb-25 swiper-slide ">
                                 <div class="tp-product-thumb p-relative fix m-img">
                                    <a href="product-details.html">
                                       <img src="assets-front/img/product/product-7.jpg" alt="product-electronic">
                                    </a>
                              ...
                              <div class="tp-product-item transition-3 mb-25 swiper-slide ">
                                 <div class="tp-product-thumb p-relative fix m-img">
                                    <a href="product-details.html">
                                       <img src="assets-front/img/product/product-8.jpg" alt="product-electronic">
                                    </a>
                              ...
                              <div class="tp-product-item transition-3 mb-25 swiper-slide ">
                                 <div class="tp-product-thumb p-relative fix m-img">
                                    <a href="product-details.html">
                                       <img src="assets-front/img/product/product-9.jpg" alt="product-electronic">
                                    </a>
                              ...
                              <div class="tp-product-item transition-3 mb-25 swiper-slide ">
                                 <div class="tp-product-thumb p-relative fix m-img">
                                    <a href="product-details.html">
                                       <img src="assets-front/img/product/product-10.jpg" alt="product-electronic">
                                    </a>
                        ...
                        <div class="tp-product-sm-wrapper mr-20">
                           <div class="tp-product-sm-item d-flex align-items-center">
                              <div class="tp-product-thumb mr-25 fix">
                                 <a href="product-details.html">
                                    <img src="assets-front/img/product/sm/product-sm-1.jpg" alt="">
                                 </a>
                              </div>
                           ...
                           <div class="tp-product-sm-item d-flex align-items-center">
                              <div class="tp-product-thumb mr-25 fix">
                                 <a href="product-details.html">
                                    <img src="assets-front/img/product/sm/product-sm-2.jpg" alt="">
                                 </a>
                              </div>
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
                           ...
                           <div class="tp-product-sm-item d-flex align-items-center">
                              <div class="tp-product-thumb mr-25 fix">
                                 <a href="product-details.html">
                                    <img src="assets-front/img/product/sm/product-sm-3.jpg" alt="">
                                 </a>
                              </div>
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
                     ...
                     <div class="tp-product-sm-list mb-50">
                        ...
                        <div class="tp-product-sm-wrapper mr-20">
                           <div class="tp-product-sm-item d-flex align-items-center">
                              <div class="tp-product-thumb mr-25 fix">
                                 <a href="product-details.html">
                                    <img src="assets-front/img/product/sm/product-sm-4.jpg" alt="">
                                 </a>
                              </div>
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
                           ...
                           <div class="tp-product-sm-item d-flex align-items-center">
                              <div class="tp-product-thumb mr-25 fix">
                                 <a href="product-details.html">
                                    <img src="assets-front/img/product/sm/product-sm-5.jpg" alt="">
                                 </a>
                              </div>
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
                           ...
                           <div class="tp-product-sm-item d-flex align-items-center">
                              <div class="tp-product-thumb mr-25 fix">
                                 <a href="product-details.html">
                                    <img src="assets-front/img/product/sm/product-sm-6.jpg" alt="">
                                 </a>
                              </div>
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
                     ...
                     <div class="tp-product-sm-list mb-50">
                        ...
                        <div class="tp-product-sm-wrapper mr-20">
                           <div class="tp-product-sm-item d-flex align-items-center">
                              <div class="tp-product-thumb mr-25 fix">
                                 <a href="product-details.html">
                                    <img src="assets-front/img/product/sm/product-sm-7.jpg" alt="">
                                 </a>
                              </div>
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
                           ...
                           <div class="tp-product-sm-item d-flex align-items-center">
                              <div class="tp-product-thumb mr-25 fix">
                                 <a href="product-details.html">
                                    <img src="assets-front/img/product/sm/product-sm-8.jpg" alt="">
                                 </a>
                              </div>
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
                           ...
                           <div class="tp-product-sm-item d-flex align-items-center">
                              <div class="tp-product-thumb mr-25 fix">
                                 <a href="product-details.html">
                                    <img src="assets-front/img/product/sm/product-sm-9.jpg" alt="">
                                 </a>
                              </div>
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
               ...
               <div class="row row-cols-lg-5 row-cols-md-3 row-cols-sm-2 row-cols-1">
                  <div class="col">
                     <div class="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
                        <img src="assets-front/img/instagram/instagram-1.jpg" alt="">
                        <div class="tp-instagram-icon">
                           <a href="assets-front/img/instagram/instagram-1.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
                        <img src="assets-front/img/instagram/instagram-2.jpg" alt="">
                        <div class="tp-instagram-icon">
                           <a href="assets-front/img/instagram/instagram-2.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
                        <img src="assets-front/img/instagram/instagram-3.jpg" alt="">
                        <div class="tp-instagram-icon">
                           <a href="assets-front/img/instagram/instagram-3.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
                        <img src="assets-front/img/instagram/instagram-4.jpg" alt="">
                        <div class="tp-instagram-icon">
                           <a href="assets-front/img/instagram/instagram-4.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col">
                     <div class="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
                        <img src="assets-front/img/instagram/instagram-5.jpg" alt="">
                        <div class="tp-instagram-icon">
                           <a href="assets-front/img/instagram/instagram-5.jpg" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <section class="tp-subscribe-area pt-70 pb-65 theme-bg p-relative z-index-1">
            <div class="tp-subscribe-shape">
               <img class="tp-subscribe-shape-1" src="assets-front/img/subscribe/subscribe-shape-1.png" alt="">
               <img class="tp-subscribe-shape-2" src="assets-front/img/subscribe/subscribe-shape-2.png" alt="">
               <img class="tp-subscribe-shape-3" src="assets-front/img/subscribe/subscribe-shape-3.png" alt="">
               <img class="tp-subscribe-shape-4" src="assets-front/img/subscribe/subscribe-shape-4.png" alt="">
               <!-- plane shape -->
               <div class="tp-subscribe-plane">
                  <img class="tp-subscribe-plane-shape" src="assets-front/img/subscribe/plane.png" alt="">
                        ...
                        <nav>
                           <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                              <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1" type="button" role="tab" aria-controls="nav-1" aria-selected="true">
                                 <img src="assets-front/img/product/details/nav/product-details-nav-1.jpg" alt="">
                              </button>
                              <button class="nav-link" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2" type="button" role="tab" aria-controls="nav-2" aria-selected="false">
                                 <img src="assets-front/img/product/details/nav/product-details-nav-2.jpg" alt="">
                              </button>
                              <button class="nav-link" id="nav-3-tab" data-bs-toggle="tab" data-bs-target="#nav-3" type="button" role="tab" aria-controls="nav-3" aria-selected="false">
                                 <img src="assets-front/img/product/details/nav/product-details-nav-3.jpg" alt="">
                              </button>
                              <button class="nav-link" id="nav-4-tab" data-bs-toggle="tab" data-bs-target="#nav-4" type="button" role="tab" aria-controls="nav-4" aria-selected="false">
                                 <img src="assets-front/img/product/details/nav/product-details-nav-4.jpg" alt="">
                              </button>
                           </div>
                        </nav>
                        <div class="tab-content m-img" id="productDetailsNavContent">
                           <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab" tabindex="0">
                              <div class="tp-product-details-nav-main-thumb">
                                 <img src="assets-front/img/product/details/main/product-details-main-1.jpg" alt="">
                              </div>
                           </div>
                           <div class="tab-pane fade" id="nav-2" role="tabpanel" aria-labelledby="nav-2-tab" tabindex="0">
                              <div class="tp-product-details-nav-main-thumb">
                                 <img src="assets-front/img/product/details/main/product-details-main-2.jpg" alt="">
                              </div>
                           </div>
                           <div class="tab-pane fade" id="nav-3" role="tabpanel" aria-labelledby="nav-3-tab" tabindex="0">
                              <div class="tp-product-details-nav-main-thumb">
                                 <img src="assets-front/img/product/details/main/product-details-main-3.jpg" alt="">
                              </div>
                           </div>
                           <div class="tab-pane fade" id="nav-4" role="tabpanel" aria-labelledby="nav-4-tab" tabindex="0">
                              <div class="tp-product-details-nav-main-thumb">
                                 <img src="assets-front/img/product/details/main/product-details-main-4.jpg" alt="">
                              </div>
                           </div>
                         </div>
                     </div>

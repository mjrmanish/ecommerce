                              ...
                              <div class="tp-footer-contact">
                                 <div class="tp-footer-contact-item d-flex align-items-start">
                                    ...
                                    <div class="tp-footer-contact-content">
                                       <p><a href="https://html.weblearnbd.net/cdn-cgi/l/email-protection#f182999e9788b1828481819e8385df929e9c"><span class="__cf_email__" data-cfemail="95e6fdfaf3ecd5e6e0e5e5fae7e1bbf6faf8">[email&#160;protected]</span></a></p>
                                    </div>
                                 </div>
                                 <div class="tp-footer-contact-item d-flex align-items-start">
                                    <div class="tp-footer-contact-icon">
                     ...
                     <div class="row align-items-center">
                        ...
                        <div class="col-md-6">
                           <div class="tp-footer-payment text-md-end">
                              <p>
                                 <img src="assets-front/img/footer/footer-pay.png" alt="">
                              </p>
                           </div>
                        </div>
                     </div>
...
<script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="assets-front/js/vendor/jquery.js"></script>
 <script src="assets-front/js/vendor/waypoints.js"></script>
 <script src="assets-front/js/bootstrap-bundle.js"></script>
 <script src="assets-front/js/meanmenu.js"></script>
 <script src="assets-front/js/swiper-bundle.js"></script>
 <script src="assets-front/js/slick.js"></script>
 <script src="assets-front/js/range-slider.js"></script>
 <script src="assets-front/js/magnific-popup.js"></script>
 <script src="assets-front/js/nice-select.js"></script>
 <script src="assets-front/js/purecounter.js"></script>
 <script src="assets-front/js/countdown.js"></script>
 <script src="assets-front/js/wow.js"></script>
 <script src="assets-front/js/isotope-pkgd.js"></script>

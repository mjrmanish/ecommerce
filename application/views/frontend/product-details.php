                  ...
                  <div class="row">
                           ...
                           <!-- <nav>
                              <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                                 <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1" type="button" role="tab" aria-controls="nav-1" aria-selected="true">
                                    <img src="/upload/product/<?=$product->pro_main_image?>" alt="<?=$product->pro_name?>">
                                 </button>
                     ...
                     <div class="col-xl-5 col-lg-6">
                        <div class="tp-product-details-wrapper">
                           ...
                           <h3 class="tp-product-details-title"><?=$product->pro_name?></h3>
                           ...
                           <p><?=$product->highlights?><span>See more</span></p>
   
                           <!-- price -->
                           <div class="tp-product-details-price-wrapper mb-20">
                              <span class="tp-product-details-price old-price">₹<?=number_format($product->mrp)?></span>
                              <span class="tp-product-details-price new-price">₹<?=number_format($product->selling_price)?></span>
                           </div>
                        ...
                        <div class="tp-product-details-tab-nav tp-tab">
                           <nav>
                              <div class="nav nav-tabs   p-relative tp-product-tab" id="navPresentationTab" role="tablist">
                                <button class="nav-link show active" id="nav-description-tab" data-bs-toggle="tab" data-bs-target="#nav-description" type="button" role="tab" aria-controls="nav-description" aria-selected="true">Description</button>

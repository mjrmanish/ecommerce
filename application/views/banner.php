                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input type="file" class="form-control" name="bann_image"  id="pin" placeholder="Banner Image">
                                                        <label for="pin">Banner Image</label>
                                                        <?php echo form_error('bann_image', '<div class="text-danger">*', '</div>') ?>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
